...
public interface PostRepository extends CrudRepository<Post, Integer>, PagingAndSortingRepository<Post, Integer> {
    ...
    Post findByPostTypeAndInternshipTermId(PostType postType, int id);
    Page<Post> findByPostTypeAndInternshipTermIdOrderByIdDesc(PostType postType, int id, Pageable pageable);
}